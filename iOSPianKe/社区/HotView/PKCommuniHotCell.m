...
@implementation PKCommunitHotCell
...
- (void)setCellHotList:(PKCommunitHotList *)cellHotList{
    
    _cellHotList = cellHotList;
    _titleLabel.text = cellHotList.title;
    _timeLabel.text = cellHotList.addtimeF;
    _writeLabel.text = [NSString stringWithFormat:@"%li",(long)cellHotList.counterList.comment];
    [_contentImage downloadImage:cellHotList.coverimg];
    _contentLabel.attributedText = [self makeText:cellHotList.content];
    
    if ([cellHotList.coverimg isEmptyString]) {
        _contentLabel.frame = CGRectMake(40, 50, VIEW_WIDTH-105, 95);
