...
- (void)layoutSubviews{
    ...
    [_userNameText mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(weakSelf.usernameLabel.mas_right);
    ...
    [_passwordText mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(weakSelf.passwordLabel.mas_right);
    ...
    [_delegateLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.equalTo(CGSizeMake(180, 15));
        make.top.equalTo(weakSelf.finishBtn.mas_bottom).offset(25);
    }];
...
- (UITextField *)emailText{
    if (!_emailText) {
        ...
        [_emailText setAutocorrectionType:(UITextAutocorrectionTypeNo)];
    }
    return _emailText;
}
